...
| :--- | :--- | :--- | :--- |
| **Software Engineering Intern** | **eDoc** | **3D Interactive Viewer (Autodesk Forge API, Angular)** | **Upcoming (Summer 2026)** |
| **Vice-Président** | **Association des Élèves Ingénieurs (ADEI)** | **Student Leadership & Events** | **2025-11 — Present** |
| Head of Pedagogical Committee | ENSIAS | Academic Logistics | 2025-11 — Present |
| Délégué de Promotion | ENSIAS | Student Representation (300+ students) | 2023 — Present |

### Education 🎓

* **Cycle d'Ingénieur d'État** in Data & Software Sciences @ ENSIAS, Rabat (2025 - Present)
* **DEUST MIP** @ FST Settat (2023 - 2025) - Major de Promotion (1st out of 400 students)
...
* **1st Place Winner** @ EITC Local Hackathon (ENSIAS Eats - Jan 2026) out of 20 teams
* **Finalist** @ Smart Trade Challenge 2026 (PortNet HARPON - Mar 2026)
* **Participant** @ UM6P Explorer Innovation Program
